...
- [AWS network connectivity management tools](https://docs.aws.amazon.com/wellarchitected/latest/management-and-governance-guide/aws-network-connectivity-management-tools.html)
...
- [localstack | Github](https://github.com/localstack/localstack) | A fully functional local AWS cloud stack. Develop and test your cloud & Serverless apps offline
